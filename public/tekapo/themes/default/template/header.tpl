      ...
      <ul id="header_employee_box" class="component">
        <li id="employee_infos" class="dropdown hidden-xs">
          ...
          <ul id="employee_links" class="dropdown-menu dropdown-menu-right">
            ...
            <li class="text-left text-nowrap username" data-mobile="true" data-from="employee_links" data-target="menu">歡迎<br>{$employee->lastname}{$employee->firstname}{*l s='Welcome back %name%' sprintf=['%name%' => $employee->firstname] d='Admin.Navigation.Header'*}</li>
            ...
            {* suzy: 2020-05-17 隱藏連結 <li class="divider"></li>
