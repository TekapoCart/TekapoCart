				...
				<div class="row">
					...
					{if isset($customer->firstname)}
						<h2>
                            ...
                            {* suzy: 2018-09-15 姓氏先 *}{$customer->lastname|escape:'html':'UTF-8'} {$customer->firstname|escape:'html':'UTF-8'} <small>({$customer->email|escape:'html':'UTF-8'})</small>
							</a>
						</h2>
					{else}
...
<div class="panel">
	...
	<h3>{l s="Your answer to" d='Admin.Orderscustomers.Feature'} {if isset($customer->firstname)}{* suzy: 2018-09-15 姓氏先 *}{$customer->lastname|escape:'html':'UTF-8'} {$customer->firstname|escape:'html':'UTF-8'}{else} {$thread->email}{/if}</h3>
	<div class="row">
		<div class="media">
			<div class="pull-left">
