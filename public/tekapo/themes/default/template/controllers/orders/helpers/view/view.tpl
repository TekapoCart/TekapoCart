...
{block name="override_tpl"}
            ...
            <form action="{$currentIndex|escape:'html':'UTF-8'}&amp;vieworder&amp;token={$smarty.get.token}" method="post" class="form-horizontal well hidden-print">
              <div class="row">
                <div class="col-lg-9">
                  ...
                  {/foreach*}
                  {foreach from=$sorted_states item=ll}
                    {foreach from=$ll key=id item=name}
                      <option value="{$id}"{if (isset($currentState) && $id == $currentState->id)} selected="selected" style="font-weight: bold" {elseif $id == '-'} disabled="disabled"{/if}>{$name}</option>
                    {/foreach}
                  {/foreach}
                  </select>
        ...
        {$HOOK_CONTENT_SHIP}
          ...
          <div class="tab-pane active" id="shipping">
            ...
            <div class="form-horizontal">
              ...
              {else}
                {* suzy: 2018-09-12 隱藏 「X 環保包裝」 <span class="label label-inactive"><i class="icon-remove"></i> {l s='Recycled packaging' d='Admin.Orderscustomers.Feature'}</span>*}
              {/if}

              {if $order->gift}
                <span class="label label-success"><i class="icon-check"></i> {l s='Gift wrapping' d='Admin.Orderscustomers.Feature'}</span>
              {else}
                {* suzy: 2018-09-12 隱藏 「X 禮品包裝」<span class="label label-inactive"><i class="icon-remove"></i> {l s='Gift wrapping' d='Admin.Orderscustomers.Feature'}</span>*}
              {/if}
            </div>
            {/if}
          </div>
          ...
          <div class="tab-pane" id="returns">
            ...
            <!-- Return block -->
              ...
              <div class="list-empty hidden-print">
                <div class="list-empty-msg" {* suzy: 2018-09-14 縮小字 *} style="font-size: 0.8rem">
                  <i class="icon-warning-sign list-empty-icon" {* suzy: 2018-09-14 縮小字 *} style="font-size: 44px"></i>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr class="current-edit hidden-print">
                  <td>
                    <div class="input-group {* suzy: 2018-09-12 fixed-width-xl 改成 lg *} fixed-width-lg">
              ...
              <!-- Shipping address -->
                ...
                <div class="well">
                  <div class="row">
                    ...
                    {* suzy: 2018-09-13 隱藏 Google Maps <div class="col-sm-6 hidden-print">
      ...
      <div class="panel">
        ...
        {if (sizeof($messages))}
          <div class="panel panel-highlighted">
            <div class="message-item" {* suzy: 2018-09-12 改 margin-left *} style="margin-left: 0">
              {foreach from=$messages item=message}
                {* suzy: 2018-09-17 隱藏 avatar<div class="message-avatar">
                  <div class="avatar-md">
                ...
                <div class="message-body" {* suzy: 2018-09-17 改 style *} style="margin: 0;">
                  <h4 class="message-item-heading">
                    ...
                    {if ($message['private'] == 1)}
                      {* suzy: 2018-09-22 調整位置、顯示文字 *}
                      <span style="font-size: 0.8rem">(前台隱藏)</span>
                    {/if}
                  </h4>
  ...
  <script type="text/javascript">
    /* suzy: 2018-09-13 隱藏 Google Maps
