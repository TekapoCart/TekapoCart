...
class Smilepay_c2cOverride extends Smilepay_c2c
{
    ...
    public function hookdisplayCarrierExtraContent($params)
    {
        ...
        $template = "<div id='smilepay_c2cp_emap_but' style='margin-left: 35px;'><p><button type='button' onclick='window.open(\"$url\",\"_self\");' class='btn btn-primary'>".$maptext ."</button>&nbsp;&nbsp;&nbsp;&nbsp;"
            .$mapstoretext."</p></div>";
