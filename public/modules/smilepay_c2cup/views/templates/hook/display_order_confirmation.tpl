...
{if $smilepay_c2cup_status==1}
    <dl>
        <dt>{l s='c2c Pur_name :' mod='smilepay_c2cup'}</dt>
        <dd>{$smilepay_c2cup_customer_name}</dd>
        <dt>{l s='c2c Mobile_number :' mod='smilepay_c2cup'}</dt>
        <dd>{$smilepay_c2cup_customer_phone}</dd>
        <dt>{l s='c2c Storeid :' mod='smilepay_c2cup'}</dt>
        <dd>{$smilepay_c2cup_store_id}</dd>
        <dt>{l s='c2c Storename :' mod='smilepay_c2cup'}</dt>
        <dd>({$smilepay_c2cup_cvs_store_name}){$smilepay_c2cup_store_name}</dd>
        <dt>{l s='c2c Storeaddress :' mod='smilepay_c2cup'}</dt>
