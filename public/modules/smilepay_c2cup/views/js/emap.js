    ...
    prestashop.on(
      ...
      function (params) {
          ...
          if (params['dataForm'][0].value != "undefined") {
              ...
              if (carrier_smilepayc2cup_711 != "undefined") {
                  if (carrier_smilepayc2cup_711 == current_deliver) {
              ...
              if (carrier_smilepayc2cup_fami != "undefined") {
                  if (carrier_smilepayc2cup_fami == current_deliver) {
                      if (params.deliveryOption.find(".carrier-extra-content").length == 0) {
                          $(params.deliveryOption).next(".carrier-extra-content").slideDown();
                      }
                      else {
