...
class Tc_Home2ResendShippingOrderModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        try {
            ...
            Tc_Home2::logMessage(sprintf('Tc_Home2ResendShippingOrder exception: %s %s', $order_id, $e->getMessage()), true);
        }
