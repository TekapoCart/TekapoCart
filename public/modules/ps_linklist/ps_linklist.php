...
class Ps_Linklist extends Module implements WidgetInterface
{
    ...
    // suzy: 2018-10-09 新增連結區塊 displayShoppingCartFooter
    public function hookDisplayShoppingCartFooter($params)
    {
        $hookName = 'displayShoppingCartFooter';
        $key = 'ps_linklist|' . $hookName;
        $templateFile = 'module:ps_linklist/views/templates/hook/hook-cart-footer.tpl';
        ...
        if (!$this->isCached($templateFile, $this->getCacheId($key))) {
            ...
            $this->smarty->assign('linkBlocks', $blocks);
        }
