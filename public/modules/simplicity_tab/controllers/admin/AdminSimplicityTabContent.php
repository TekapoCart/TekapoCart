...
class AdminSimplicityTabContentController extends ModuleAdminController
{
    public $module;
    ...
    public function initContent()
    {
        ...
        if ($sModuleName) {
            ...
            return Tools::redirectAdmin($this->context->link->getAdminLink('AdminSimplicityTabContent'));
        }
        ...
        $this->context->smarty->assign([
            'base_url' => $this->context->link->getAdminLink('AdminSimplicityTabContent', true),
