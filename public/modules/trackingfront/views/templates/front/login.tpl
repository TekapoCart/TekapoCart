	...
	<body>
		...
		<div style="width: 400px; height: 300px; background-color: #8AB50E; margin: 0 auto; color: white; font-family: arial; ">
			<div style="width: 400px; height: 65px; background-color: #567500; margin: 0 auto; color: white; font-family: arial; text-align: center">
				<div style="font-size: 36px;  margin: 5px auto; font-weight: bold; height: 65x; line-height: 65px; vertical-align: middle;">{l s='Affiliation space' d='Modules.Trackingfront.Shop'}</div>
			</div>
			<form action="{$request_uri|escape:'html':'UTF-8'}" method="post" style="margin: 20px 50px; text-align: left; font-weight: bold;">
				<label>{l s='Sign in' d='Modules.Trackingfront.Shop'}</label><br />
				...
				<div style="margin: 2.0em 0 0 0;">
					<label>{l s='Password' d='Modules.Trackingfront.Shop'}</label><br />
					<input type="password" name="passwd" class="input" />
				</div>
				<div style="margin: 2.0em 0 0 0; text-align :right">
					<div id="submit"><input type="submit" name="submitLoginTracking" value="{l s='Sign in' d='Modules.Trackingfront.Shop'}" class="button" style="border: none; background-color: #567500; color: white; font-weight: bold; width: 90px; height: 30px;" /></div>
				</div>
			</form>
		</div>
