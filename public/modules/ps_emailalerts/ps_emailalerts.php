...
class Ps_EmailAlerts extends Module
{
    ...
    protected function postProcess()
    {
        ...
        } elseif (Tools::isSubmit('submitContactform')) {  // suzy: 2018-10-12 新增 submitContactform
            if (!Configuration::updateValue('CONTACTFORM_SEND_NOTIFICATION_EMAIL', (int)Tools::getValue('CONTACTFORM_SEND_NOTIFICATION_EMAIL'))) {
                $errors[] = $this->trans('Cannot update settings', array(), 'Modules.Mailalerts.Admin');
            } elseif (!Configuration::updateGlobalValue('PS_CUSTOMER_SERVICE_FILE_UPLOAD', (int)Tools::getValue('PS_CUSTOMER_SERVICE_FILE_UPLOAD'))) {
                $errors[] = $this->trans('Cannot update settings', array(), 'Modules.Mailalerts.Admin');
            }
        ...
        } else if (Tools::isSubmit('submitMailAlert') || Tools::isSubmit('submitMAMerchant') || Tools::isSubmit('submitContactform')) { // suzy: 2018-10-12 新增 submitContactform
    ...
    public function hookActionOrderEdited($params)
    {
        ...
        $data = array(
            ...
            '{firstname}' => Tools::maskString($order->getCustomer()->firstname, 'name'),
    ...
    public function renderForm()
    {
        ...
        // suzy: 2018-10-12 添加聯絡我們的設定（原本在 contactform module）
        $fields_form_3 = array(
            'form' => array(
                'legend' => array(
                    'title' => '聯絡我們（客服問答）',
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'is_bool' => true,
                        'label' => '允許檔案上傳',
                        'name' => 'PS_CUSTOMER_SERVICE_FILE_UPLOAD',
                        'values' => array(
                            array(
                                'id' => 'upload_on',
                                'value' => 1,
