...
//        ],
        ...
        2 => [
            ...
            'title' => '熱賣商品',
            'page' => 'best-sales',
            'url_rewrite' => 'best-sales',
        ],
        6 => [
            'id_meta' => 6,
            'title' => '新品上架',
            'page' => 'new-products',
            'url_rewrite' => 'new-products',
        ],
        8 => [
            'id_meta' => 8,
            'title' => '特價商品',
            'page' => 'prices-drop',
            'url_rewrite' => 'prices-drop',
        ],
        // suzy: 2018-11-14 新增獨立頁面「瀏覽紀錄」
        51 => [
            'id_meta' => 51,
            'title' => '瀏覽紀錄',
            'page' => 'viewed-products',
            'url_rewrite' => 'viewed-products',
        ],
    ];
    ...
    public function __construct()
    {
        ...
        /* suzy: 2018-10-10 直接指定 type_array
        ...
        */
        $this->type_array = array('home', 'meta', 'product', 'category', 'cms');
    }
