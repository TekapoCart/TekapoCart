...
class Tc_711ResendShippingOrderModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        try {
            ...
            Ecpay_Tcat::logMessage(sprintf('Tc_711ResendShippingOrder exception: %s %s', $order_id, $e->getMessage()), true);
        }
