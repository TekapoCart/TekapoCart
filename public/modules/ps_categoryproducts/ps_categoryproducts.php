...
class Ps_Categoryproducts extends Module implements WidgetInterface
{
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitCross')) {
            ...
            if ($isValidDisplayPrice) {
                ...
                // suzy: 2019-03-20 可以包含自己
                Configuration::updateValue('CATEGORYPRODUCTS_DISPLAY_CURRENT', (int) Tools::getValue('CATEGORYPRODUCTS_DISPLAY_CURRENT'));
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'label' => '包含目前商品',
                        'desc' => '是否同時顯示商品本身',
                        'name' => 'CATEGORYPRODUCTS_DISPLAY_CURRENT',
                        'values' => array(
                            array(
                                'id' => 'active_on',
                                'value' => 1,
    ...
    public function getConfigFieldsValues()
    {
        return array(
            ...
            // suzy: 2019-03-20 可以包含自己
            'CATEGORYPRODUCTS_DISPLAY_CURRENT' => Configuration::get('CATEGORYPRODUCTS_DISPLAY_CURRENT'),
        );
    }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = array())
    {
        ...
        if ($params) {
            ...
            // suzy: 2019-03-18 帶分類標題
            $category = new Category($params['id_category'], $this->context->language->id);
    ...
    private function getCategoryProducts($idProduct, $idCategory)
    {
        ...
        foreach ($products as $rawProduct) {
            ...
            // suzy: 2019-03-18 可以包含自己
            $show = (bool) Configuration::get('CATEGORYPRODUCTS_DISPLAY_CURRENT') ? true : $rawProduct['id_product'] !== $idProduct;
            // if ($rawProduct['id_product'] !== $idProduct && count($productsForTemplate) < (int) Configuration::get('CATEGORYPRODUCTS_DISPLAY_PRODUCTS')) {
            if ($show && count($productsForTemplate) < (int) Configuration::get('CATEGORYPRODUCTS_DISPLAY_PRODUCTS')) {
