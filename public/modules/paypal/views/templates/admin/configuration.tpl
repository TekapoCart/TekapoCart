...
<div class="container-fluid paypal-nav">
    <ul class="nav nav-pills navbar-separator">
        <li {if !isset($ec_paypal_active) && !isset($ec_card_active) && !isset($bt_active) && !isset($ppp_active)}class="active"{/if}><a data-toggle="pill" href="#paypal_conf"><span>{* suzy: 2019-02-25 PayPal 修改文字l s='Products' mod='paypal'*}收款方式</span></a></li>
    ...
    <div class="tab-content">
        ...
        {* suzy: 2019-02-25 PayPal 隱藏文字介紹 <div class="box half left">
            <div class="logo">
        ...
        <div class="active-products">
            <p><b>{* suzy: 2019-02-25 PayPal 隱藏文字 l s='2 PayPal products selected for you' mod='paypal'*}</b><span style="font-size: 18px;">二選一</span></p>

            <div class="col-sm-6">
                <div class="panel {if isset($ec_paypal_active) && $ec_paypal_active}active-panel{/if}">
                    {* suzy: 2019-02-25 PayPal 隱藏文字
                    ...
                    *}
                    ...
                    <div class="bottom">
                        ...
                        <a class="btn btn-default pull-right" href="{$return_url|escape:'html':'UTF-8'}&method=EC&with_card=0{if isset($ec_paypal_active) &&  $ec_paypal_active}&modify=1{/if}" >{if isset($ec_paypal_active) && $ec_paypal_active}{* suzy: 2019-02-25 l s='Modify' mod='paypal'*}設定{else}{* suzy: 2019-02-25 l s='Activate' mod='paypal'*}選用{/if}</a>
                    </div>
                </div>
            </div>
                ...
                <div class="panel {if isset($ec_active) && $ec_active && isset($ec_card_active) && $ec_card_active}actvie-panel{/if}">
                    ...
                    *}
                    ...
                    <div class="bottom">
                        ...
                        <a class="btn btn-default pull-right" href="{$return_url|escape:'html':'UTF-8'}&method=EC&with_card=1{if isset($ec_active) && $ec_active && isset($ec_card_active) && $ec_card_active}&modify=1{/if}">{if  isset($ec_active) && $ec_active && isset($ec_card_active) && $ec_card_active}{* suzy: 2019-02-25 l s='Modify' mod='paypal'*}設定{else}{* suzy: 2019-02-25 l s='Activate' mod='paypal'*}選用{/if}</a>
                    </div>
                </div>
            </div>
            {/if}
        ...
        <div style="clear:both;"></div>
        {* suzy: 2019-02-25 PayPal 隱藏文字介紹 <div class="blue">
        ...
        {* suzy: 2019-02-25 PayPal 隱藏文字介紹 if isset($ec_paypal_active) || isset($ec_card_active) || isset($bt_active) || isset($ppp_active)}
