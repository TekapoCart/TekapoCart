...
class Tc_Home3ResendShippingOrderModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        try {
            ...
            Tc_Home3::logMessage(sprintf('Tc_Home3ResendShippingOrder exception: %s %s', $order_id, $e->getMessage()), true);
        }
