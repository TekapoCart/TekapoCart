...
class Ps_Wirepayment extends PaymentModule
{
    ...
    {
        // suzy: 2019-02-05 讓 BANK_WIRE_PAYMENT_INVITE 沒作用
...
//        }
        ...
        if (
            ...
            $this->smarty->assign(array(
                ...
                'bankwireCustomText' => $bankwireCustomText, // suzy: 2018-10-28 顯示匯款完成提醒訊息
                'status' => 'ok',
    ...
    // suzy: 2019-02-05 訂單詳細顯示 ps_wirepayment 的 Payment Info
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'desc' => '銀行名稱、分行名稱', // suzy: 2018-10-28 加上 desc
                        'required' => true
                    ),
                ),
                'submit' => array(
        ...
        $fields_form_customization = array(
            'form' => array(
                ...
                'input' => array(
                    ...
                    /* suzy: 2018-11-02 隱藏 BANK_WIRE_PAYMENT_INVITE
                    array(
                        'type' => 'switch',
