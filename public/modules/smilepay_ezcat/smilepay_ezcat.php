...
include "smilepay_ezcat_orderst_1.php";

//include "smilepay_ezcat_orderst_2.php";
...
class Smilepay_ezcat extends PaymentModule
{
	...
	public function __construct()
	{
		...
		$config = Configuration::getMultiple(array('SMILEPAY_ezcat_DCVC', 'SMILEPAY_ezcat_MID', 'SMILEPAY_ezcat_Rvg2c',
                                             'SMILEPAY_ezcat_VKey','SMILEPAY_ezcat_Spdesc','SMILEPAY_ezcat_paymentName',self::SMILEPAY_EZCATP_NORMAL_CARRIER_ID,self::SMILEPAY_EZCATP_NORMAL_CARRIER_ID_REF,
                                             self::SMILEPAY_EZCATP_FRIDGE_CARRIER_ID,self::SMILEPAY_EZCATP_FRIDGE_CARRIER_ID_REF,self::SMILEPAY_EZCATP_FREEZE_CARRIER_ID,self::SMILEPAY_EZCATP_FREEZE_CARRIER_ID_REF
                                             ));
        ...
        if($state == $ezcat_status)
		{
           ...
           else
           {
               $this->smarty->assign(array(
					...
					'Status' => iconv("big5","UTF-8","�q�楢��").$xml->Status,
    ...
    {
        $support_id=array(Configuration::get(self::SMILEPAY_EZCATP_NORMAL_CARRIER_ID),Configuration::get(self::SMILEPAY_EZCATP_FRIDGE_CARRIER_ID),Configuration::get(self::SMILEPAY_EZCATP_FREEZE_CARRIER_ID));
