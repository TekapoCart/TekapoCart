...
class Tc_HomeResendShippingOrderModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        try {
            ...
            Tc_Home::logMessage(sprintf('Tc_HomeResendShippingOrder exception: %s %s', $order_id, $e->getMessage()), true);
        }
