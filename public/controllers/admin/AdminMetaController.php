...
class AdminMetaControllerCore extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->fields_list = array(
            ...
            // suzy: 2018-10-19 加 column - Meta description
            'description' => array('title' => $this->trans('Meta description', array(), 'Admin.Global')),

            // suzy: 2018-10-19 隱藏 column
            // 'url_rewrite' => array('title' => $this->trans('Friendly URL', array(), 'Admin.Global')),
        );
        $this->_where = ' AND a.configurable = 1';

        // suzy: 2018-10-19 只顯示內建特定頁面
        $this->_where .= ' AND a.id_meta IN (4, 3, 2, 6, 8, 51, 22, 14, 24)';
        ...
        if (_PS_MODE_DEV_) { // suzy: 2018-10-19 隱藏 選項
        ...
        $url_description = '';
        if (_PS_MODE_DEV_) { // suzy: 2018-10-19 隱藏 Apache 選項
        ...
        $this->fields_options = []; // suzy: 2018-10-19 隱藏選項
        if (_PS_MODE_DEV_) {
            // List of options
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'name' => 'page',
                    'disabled' => true, // suzy: 2018-10-19 不可修改
                    'options' => array(
                        'optiongroup' => array(
                            'label' => 'name',
                            'query' => $pages,
    ...
    public function postProcess()
    {
        ...
        if (Tools::isSubmit('submitAddmeta')) {
            ...
            /* suzy: 2018-10-19 by pass URL 檢查
