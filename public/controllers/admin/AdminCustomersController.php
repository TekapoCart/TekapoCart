...
class AdminCustomersControllerCore extends AdminController
{
    ...
    {
        $this->bootstrap = true;
        // suzy: 2018-07-28 不需顯示 必填欄位（那個設定 mobile_phone 為必填的功能）
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                */
                ...
                /* suzy: 2018-09-22 隱藏「接收我們的合作夥伴的優惠」欄位
                array(
                    'type' => 'switch',
                    'label' => $this->trans('Partner offers', array(), 'Admin.Orderscustomers.Feature'),
                    'name' => 'optin',
    ...
    */
    ...
    public function renderView()
    {
        ...
        $fb_social_id = (int) Db::getInstance()->getValue('SELECT id_social FROM ' .
            _DB_PREFIX_ .
            'sociallogin WHERE type="fb" AND id_customer=' . (int)$customer->id);
