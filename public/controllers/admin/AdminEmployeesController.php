...
class AdminEmployeesControllerCore extends AdminController
{
    ...
    public function renderForm()
    {
        ...
        if ($this->restrict_edition) {
            ...
            /* suzy: 2018-09-13 隱藏 PrestaShop Addons
        ...
        $this->fields_form['input'] = array_merge($this->fields_form['input'], array(
            /* suzy: 2018-07-30 隱藏 訂閱 PrestaShop newsletter
            array(
                'type' => 'switch',
    ...
    public function processSave()
    {
        ...
        if ($this->restrict_edition) {
            ...
            // suzy: 2018-09-16 加入「立即變更您的密碼」提醒
            $show_change_passwd_alert = Tools::getValue('passwd') == '12345678' ? true : false;
            $cookie = Context::getContext()->cookie;
            $cookie->change_passwd_alert = $show_change_passwd_alert;
