				...
				success: function (jsonData) {
					...
					else
					{
						for (var current_hook = 0; current_hook < jsonData.length; current_hook++)
						{
                            ...
                            hook_select.append('<option value="'+jsonData[current_hook].id_hook+'">'+jsonData[current_hook].sort+' '+jsonData[current_hook].title+' ['+jsonData[current_hook].name+']</option>');
						}
