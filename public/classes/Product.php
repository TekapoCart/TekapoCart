...
class ProductCore extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            // suzy: 2019-01-05 貼紙功能
            'sticker' =>                  array('type' => self::TYPE_STRING, 'validate' => 'isString', 'size' => 32),
    ...
    public static function getAttributesColorList(array $products, $have_stock = true)
    {
        ...
        foreach ($res as $row) {
            ...
            if (Tools::isEmpty($row['color']) && !@filemtime(_PS_COL_IMG_DIR_ . $row['id_attribute'] . '.jpg')) {
                ...
                $row['texture'] = 'https://' . Tools::getMediaServer(_THEME_COL_DIR_ . $row['id_attribute'] . '.jpg') . _THEME_COL_DIR_.$row['id_attribute'] . '.jpg';
            }
