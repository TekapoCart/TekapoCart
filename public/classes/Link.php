...
//            return '';
//        }
        $langDefault = (int) Configuration::get('PS_LANG_DEFAULT', null, null, $idShop);
        if ((!$this->allow && in_array($idShop, array($context->shop->id, null))) || !Language::isMultiLanguageActivated($idShop) || !$psRewritingSettings || $context->language->id == $langDefault) {
            if ($idLang == 1) {
                return '';
            }
        }
