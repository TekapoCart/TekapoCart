...
<IfModule mod_deflate.c>
    ...
    public static function getRobotsContent()
    {
        ...
        */
        $disallow_controllers = array(
            'addresses', 'address', 'cart', 'discount',
            'get-file', 'history', 'identity', 'my-account', 'order',
            'order-slip', 'order-detail', 'order-follow', 'order-return', 'order-confirmation',
            'pdf-invoice', 'pdf-order-return', 'pdf-order-slip', 'product-sort', 'search', 'attachment', 'guest-tracking',
        );
...
';
    ...
    public static function purifyHTML($html, $uri_unescape = null, $allow_style = false)
    {
        ...
        if ($use_html_purifier) {
            if ($purifier === null) {
                ...
                // suzy: 2018-09-16 CSS.Trusted & CSS.Proprietary
                $config->set('CSS.Trusted', true);
                $config->set('CSS.Proprietary', true);
                $config->set('CSS.AllowTricky', true);

                // suzy: 2018-09-22 MaxImgLength 支援 <img style="width: 100%">
                ...
                if ($def = $config->getHTMLDefinition(true)) {
                    ...
                    // suzy: 2018-11-18 allow HTML tag picture & source (為了支援 webp)
     ...
     * @param null $position
     * @param null $list
     * @param null $quantity_wanted
     * @return array
     */
    public static function reformatProduct($product, $position = null, $list = null, $quantity_wanted = null)
    {
