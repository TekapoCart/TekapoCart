    ...
    TWzipcode.prototype = {
        ...
        init: function () {
            ...
            var self = this,
                ...
                zipcodeName = opts.zipcodeName,
                zipcodePlaceholder = opts.zipcodePlaceholder,
                readonly = opts.readonly;

            // Elements create
            // $('<select/>')
            //     .attr('name', countyName)
            //     .addClass(('undefined' !== typeof opts.css[0] ? opts.css[0] : ''))
            //     .appendTo(container);
            //
            // $('<select/>')
            //     .attr('name', districtName)
            //     .addClass(('undefined' !== typeof opts.css[1] ? opts.css[1] : ''))
            //     .appendTo(container);
            //
            // $('<input/>')
            //     .attr({'type': 'text', 'name': zipcodeName, 'placeholder': zipcodePlaceholder})
            //     .prop('readonly', readonly)
            //     .addClass(('undefined' !== typeof opts.css[2] ? opts.css[2] : ''))
            //     .appendTo(container);

            self.wrap = {
                'county': container.find('select[name="' + countyName + '"]:first'),
                'district': container.find('select[name="' + districtName + '"]:first'),
                'zipcode': container.find('input[name="' + zipcodeName + '"]:first'),
                'city': container.find('input[name="city"]:first')
            };
