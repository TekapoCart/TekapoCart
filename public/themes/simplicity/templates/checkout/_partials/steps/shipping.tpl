        ...
        <div class="form-fields">
                      ...
                      <div class="row">
                        <div class="col-lg-5 col-xs-12">
                          <div class="{*row*}">
                            {if $carrier.logo}
                            {*<div class="col-xs-2">*}
                                <img src="{$carrier.logo}" alt="{$carrier.name}" style="width:30px; margin-right: 10px;"/>
                            {*</div>*}
                            {/if}
                            {*<div class="{if $carrier.logo}col-xs-10{else}col-xs-12{/if}">*}
                              <span class="h5 carrier-name">{$carrier.name}</span>
                            {*</div>*}
                          </div>
                        </div>
                        <div class="col-lg-5 col-xs-12">
          ...
          <div class="order-options">
            <div id="delivery">
              ...
              <textarea rows="2" cols="120" id="delivery_message" name="delivery_message" placeholder="{l s='If you would like to add a comment about your order, please write it in the field below.' d='Shop.Theme.Checkout'}">{$delivery_message}</textarea>
            </div>
