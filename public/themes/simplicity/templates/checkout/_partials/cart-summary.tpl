...
<section id="js-checkout-summary" class="card js-cart" data-refresh-url="{$urls.pages.cart}?ajax=1&action=refresh">
    ...
    {block name='cart_summary_products'}
        <div class="cart-summary-products">
            <p>
                ...
                <a href="{$urls.pages.cart}?action=show"><span class="step-edit text-muted"><i class="material-icons edit">mode_edit</i> {l s='edit cart' d='Shop.Theme.Actions'}</span></a>
            </p>
    ...
    {block name='cart_summary_subtotals'}
        {foreach from=$cart.subtotals item="subtotal"}
            {if $subtotal && $subtotal.type !== 'tax'}
                <div class="cart-summary-line cart-summary-subtotals hidden-xs-up" id="cart-subtotal-{$subtotal.type}">
    ...
    <hr id="cart-summary-separator" class="separator hidden-xs-up">
