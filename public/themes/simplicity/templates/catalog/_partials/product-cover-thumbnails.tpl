...
<div class="images-container">
  {block name='product_cover'}
    <div class="product-cover">
      {if $product.cover.bySize.large_default.has_webp}
        ...
        <img
          ...
          data-src-mobile="{$product.cover.bySize.large_default.url}"
          data-src="{$product.cover.bySize.large_default.url}"
          style="width:100%;"
          itemprop="image"
        />
      {else}
        <img class="js-qv-product-cover" src="{$product.cover.bySize.large_default.url}" alt="{if !empty($product.cover.legend)}{$product.cover.legend}{else}{$product.name|truncate:70:'...'}{/if}" title="{$product.cover.legend}" style="width:100%;" itemprop="image" />
      {/if}
