  ...
  {block name='order_infos'}
    <div id="order-infos">
      <div class="box">
        ...
        <div class="row">
          <div class="col-xs-12">
            <p><strong>{l s='Payment method' d='Shop.Theme.Checkout'}</strong> {$order.details.payment}</p>
            <p><strong>{l s='Carrier' d='Shop.Theme.Checkout'}</strong> {$order.carrier.name} - {$order.carrier.delay}</p>
      ...
      <div class="box">
        ...
        <div class="hidden-md-up shipping-lines">
          ...
          <div class="shipping-line">
            <ul>
              <li><strong>{l s='Date' d='Shop.Theme.Global'}</strong> {$line.shipping_date}</li>
              <li><strong>{l s='Carrier' d='Shop.Theme.Checkout'}</strong> {$line.carrier_name}</li>
              <li><strong>{l s='Weight' d='Shop.Theme.Checkout'}</strong> {$line.shipping_weight}</li>
              <li><strong>{l s='Shipping cost' d='Shop.Theme.Checkout'}</strong> {$line.shipping_cost}</li>
              <li><strong>{l s='Tracking number' d='Shop.Theme.Checkout'}</strong> {$line.tracking nofilter}</li>
            </ul>
          </div>
          {/foreach}
        </div>
