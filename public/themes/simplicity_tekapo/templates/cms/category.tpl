    ...
    {if $cms_pages}
        <ul class="cms-page-list">
            ...
            <li class="cms-page-item">
                <div class="cms-page-cover"{if isset($cms_page.image)} style="background-image: url('{$cms_page.image}?{$smarty.const._TC_VERSION_DATE_}{$shop.ccccss_version}');"{else} style="background-image: url('/img/cms/page/0.jpg?{$smarty.const._TC_VERSION_DATE_}{$shop.ccccss_version}');"{/if}">
